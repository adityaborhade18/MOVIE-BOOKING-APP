...
const Footer =()=>{
    ...
    return (
        <footer className="px-6 md:px-16 mt-40 lg:px-24 xl:px-32 w-full">
            <div className="flex flex-col md:flex-row items-start justify-center gap-10 py-10 border-b border-gray-500/30">
                
                <div className="max-w-96">
                  <button onClick={()=>{scrollTo(0,0); Navigate('/')}}>
                    ...
                    <div className="flex items-center gap-2 mt-3">
                        ...
                        <a href="https://github.com/adityaborhade18">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="https://www.linkedin.com/in/adityaborhade18/">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <p className="py-4 text-center text-xs md:text-sm text-gray-500">
                Copyright {new Date().getFullYear()} © Aditya Borhade All Right Reserved.
            </p>
        </footer>
    );
};
